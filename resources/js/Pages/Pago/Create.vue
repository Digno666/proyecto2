<template>
           ...
           <form @submit.prevent="submitPayment">
             ...
             <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
               <div class="form-group">
                 <label for="tnTipoServicio" class="block text-sm font-medium text-gray-700 bb">Tipo de Servicio</label>
               ...
               <div class="form-group">
                 <label for="tnTelefono" class="block text-sm font-medium text-gray-700 bb">Número de cuenta</label>
                 <input
                   type="text"
 ...
 export default {
   ...
   this.$inertia.post(this.route('consumirServicio2'), this.form)
     ...
     goBack() {
       this.$inertia.visit(this.route('reserva-cliente.index'));
     },
