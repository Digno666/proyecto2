...
class TrabajadorController extends Controller
{
    ...
    {
        $vendedor = Trabajador::findOrFail($id);
    ...
    public function update(Request $request, $id)
    {
        ...
        $encargado = Trabajador::findOrFail($id);
    ...
    {
        $vendedor = Trabajador::where('carnetIdentidad', $carnetIdentidad)->first();
        if ($vendedor) {
            $vendedor->delete();
